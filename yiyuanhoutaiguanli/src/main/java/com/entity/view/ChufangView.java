 ...
 */
@TableName("chufang")
public class ChufangView extends ChufangEntity implements Serializable {
	...
	public ChufangView(ChufangEntity chufangEntity) {
		try {
			BeanUtils.copyProperties(this, chufangEntity);
