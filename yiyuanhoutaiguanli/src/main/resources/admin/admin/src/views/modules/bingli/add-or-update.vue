    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yishengId" name="yishengId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="入院途径" prop="ruyuantujingTypes">
                        <el-select v-model="ruleForm.ruyuantujingTypes" :disabled="ro.ruyuantujingTypes" placeholder="请选择入院途径">
                            <el-option
                                v-for="(item,index) in ruyuantujingTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="入院途径" prop="ruyuantujingValue">
                        <el-input v-model="ruleForm.ruyuantujingValue"
                            placeholder="入院途径" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="诊断" prop="zhenduanContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.zhenduanContent" label="诊断" prop="zhenduanContent">
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   ruyuantujingTypes: [
                              { required: true, message: '入院途径不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=ruyuantujing_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.ruyuantujingTypesOptions = data.data.list;
                    }
                });
